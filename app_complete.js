  ...
  navigate(screenName) {
    ...
    switch(screenName) {
      ...
      case "vol":
        UIEngine.render(
          "app",
          ScreenEngine.createVolSelectScreen()
        );
        break;
      ...
      case "mode":
        UIEngine.render(
          "app",
          ScreenEngine.createModeSelectScreen()
        );
        break;
      ...
      case "backup":
        UIEngine.render(
          "app",
          ScreenEngine.createBackupScreen()
        );
        break;
      ...
      case "settings":
        UIEngine.render(
          "app",
          ScreenEngine.createSettingsScreen()
        );
        break;
    }
  },
